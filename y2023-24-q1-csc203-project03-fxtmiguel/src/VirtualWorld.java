    ...
    */
    ...
    public void mousePressed() {
        ...
        if (entityOptional.isPresent()) {
            ...
            System.out.println(entity.id + ": " + entity.getKey()+ " : " );
        }
    ...
    public void parseSaveFile(WorldModel world, Scanner saveFile, ImageStore imageStore, Background defaultBackground){
        String lastHeader = "";
        int headerLine = 0;
        int lineCounter = 0;
        while(saveFile.hasNextLine()){
            ...
            if(line.endsWith(":")){
                ...
                switch (lastHeader){
                    ...
                    case "Backgrounds:" -> world.parseBackgroundRow(world, line, lineCounter-headerLine-1, imageStore);
